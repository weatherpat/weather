...
function writeday()
{
document.getElementById("y").innerHTML=nyear; 
document.getElementById("m").innerHTML=nmonth; 
document.getElementById("n").innerHTML=nday; 
document.getElementById("w").innerHTML=cweekday(nwday); 
document.getElementById("nl").innerHTML=lmonth+"月"+lday;
}
...
document.getElementById("hrs").innerHTML=shape(nhrs); 
document.getElementById("min").innerHTML=shape(nmin); 
document.getElementById("sec").innerHTML=shape(nsec); 
